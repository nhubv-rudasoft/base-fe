export function OutgoingWidget() {
  return (
    <div className='flex flex-col gap-3 rounded-2xl border border-gray-200 bg-white p-5'>
      <div className='flex justify-between'>
        <div className='flex flex-row items-center gap-2'>
          <span className='flex h-8 w-8 items-center justify-center rounded-lg border border-yellow-200 shadow-sm'>
            <i className='flex h-4 w-4 items-center justify-center rounded-full border border-yellow-500 bg-yellow-200 text-xs font-semibold text-yellow-600'>
              $
            </i>
          </span>
          <p className='font-sm text-gray-700'>Outgoing</p>
        </div>
      ...
      <div className='flex flex-col items-start gap-2 md:flex-col md:items-start lg:flex-row lg:items-center'>
        <p className='text-xl font-extrabold text-black'>
          $ 1,800.00
          <span className='text-xs font-light text-yellow-600'>-30%</span>
        </p>
      ...
      <div className='rounded-md bg-yellow-50'>
        <div className='flex flex-col p-3'>
          <p className='text-sm text-yellow-600'>Latest outgoing</p>
