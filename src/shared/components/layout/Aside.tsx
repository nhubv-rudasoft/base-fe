...
import { TbMessagePin, TbPigMoney } from 'react-icons/tb';
...
export default function Aside() {
  ...
  useEffect(() => {
    setIsOpen(settings.isOpenSidebar);
  }, [settings.isOpenSidebar]);
      ...
      >
        <div className='flex h-full flex-col gap-4 overflow-y-auto px-4 py-6'>
          ...
          <div className='relative py-2'>
            ...
            />
            <FiSearch size={18} className='absolute inset-y-0 top-5 left-3 flex items-center' />
